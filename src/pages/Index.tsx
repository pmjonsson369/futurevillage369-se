  ...
  <div className="bg-dark text-dark-foreground">
    ...
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center px-6 py-32">
        ...
        <h1 className="text-[2.25rem] sm:text-5xl md:text-6xl lg:text-7xl xl:text-[7.5rem] font-serif text-white leading-[1.02] mb-8 tracking-[-0.035em] animate-fade-in max-w-5xl mx-auto text-glow">
          Smarta trädgårdar
          <br />
          <span className="text-white/85">för framtidens<br />nordiska livsstil</span>
        </h1>
